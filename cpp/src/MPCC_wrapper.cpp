...
BOOST_PYTHON_MODULE(MPCC_WRAPPER)
{
    ...
    class_<StateInputIndex>("StateInputIndex")
        ...
        .def_readonly("ddq1", &StateInputIndex::ddq1)
        .def_readonly("ddq2", &StateInputIndex::ddq2)
        .def_readonly("ddq3", &StateInputIndex::ddq3)
        .def_readonly("ddq4", &StateInputIndex::ddq4)
        .def_readonly("ddq5", &StateInputIndex::ddq5)
        .def_readonly("ddq6", &StateInputIndex::ddq6)
        .def_readonly("ddq7", &StateInputIndex::ddq7)
    ...
    class_<State>("State")
        ...
        .def_readwrite("dq1", &State::dq1)
        .def_readwrite("dq2", &State::dq2)
        .def_readwrite("dq3", &State::dq3)
        .def_readwrite("dq4", &State::dq4)
        .def_readwrite("dq5", &State::dq5)
        .def_readwrite("dq6", &State::dq6)
        .def_readwrite("dq7", &State::dq7)
    ...
    class_<Input>("Input")
        .def_readwrite("ddq1", &Input::ddq1)
        .def_readwrite("ddq2", &Input::ddq2)
        .def_readwrite("ddq3", &Input::ddq3)
        .def_readwrite("ddq4", &Input::ddq4)
        .def_readwrite("ddq5", &Input::ddq5)
        .def_readwrite("ddq6", &Input::ddq6)
        .def_readwrite("ddq7", &Input::ddq7)
    ...
    def("stateTodJointVector", stateTodJointVector);
    def("inputToddJointVector", inputToddJointVector);
